...
if (isset($_GET['delete_id'])) {
    ...
    if ($stmt->affected_rows > 0) {
        ...
        echo "window.location.href='brandlist.php';";
    } else {
        // In case of failure
        echo "<script>alert('Error deleting product.'); window.location.href='brandlist.php';</script>";
    }
...
$sql = "SELECT id, name, brand_image FROM brands";
            ...
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="addbrand.php" class="btn btn-added">
                        <img src="assets/img/icons/plus.svg" alt="img" class="me-1"> Add New Brand
                    </a>
                </div>
            </div>
            <div class="card">
                                        ...
                                        <tr class="text-center align-middle">
                                            ...
                                            <td>
                                                <?php if (!empty($row['brand_image'])): ?>
                                                    <img src="<?= htmlspecialchars($row['brand_image']); ?>" width="40" height="40" style="border-radius: 5px;">
                                                <?php else: ?>
                                                    <span>No Image</span>
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td>
                                                <a href="editbrand.php?id=<?= $row['id']; ?>" class="text-success fw-bold">Edit</a> | 
                                                <a href="brandlist.php?delete_id=<?= $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this brand?');" class="text-danger fw-bold">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
